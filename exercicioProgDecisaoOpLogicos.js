...
function exercicio12() {
  ...
  alert(`Dentre os numeros digitados o maior: ${maior} e o menor: ${menor}`);
}
...
function exercicio13() {
  ...
  if (a > b && a > c) {
    if (b > c) {
      alert(`Em ordem crescente ${c}, ${b} e ${a}`);
    } else {
      alert(`Em ordem crescente ${b}, ${c} e ${a}`);
    }
  }

  if (b > c) {
    if (a > c) {
      alert(`Em ordem crescente ${c}, ${a} e ${b}`);
    } else {
      alert(`Em ordem crescente ${a}, ${c} e ${b}`);
    }
  }

  if (c > a && c > b) {
    if (a > b) {
      alert(`Em ordem crescente ${b}, ${a} e ${c}`);
    } else {
      alert(`Em ordem crescente ${a}, ${b} e ${c}`);
    }
  }
}
